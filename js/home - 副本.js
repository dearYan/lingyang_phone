...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        if (s.params.pagination) {
            s.paginationContainer = $(container).find(s.params.pagination);
        ...
        s.onTouchEnd = function (e) {
            ...
            if(s.params.isContinueAutoplay){
                s.startAutoplay();
            }
        };
        /*=========================
...
(function(){
    ...
    // Events.getDist = getDist;
    Events.getSwipeDirection = getSwipeDirection;
    EVENT = Events;
...
var common = {
  ...
  navigationEvent : function(){
        EVENT.bindEvent($(".header_container"),".collspase","click",function(){
            $(".collspased_items").off("webkitAnimationEnd");
            $(".collspased_container").show();
            $(".collspased_container .collspased_items").removeClass("hide_navigator").addClass("show_navigator");
            $(".collspase").hide();
            $(".collspased").show();
            // $(".collspased_items")[0].removeEventListener("webkitAnimationEnd",function(){
            //      $(".collspased_container").show();
            //  },false);
            // $(".collspased_items")[0].removeEventListerner("webkitAnimationEnd",function(){
            //     $(".collspased_container").hide();
            // },false)
        });
        EVENT.bindEvent($(".header_container"),".collspased","click",function(){
            hideNavigator();
        });
        EVENT.bindEvent($("body"),".return_bottom","click",function(){
            $('body').scrollTop(0);
        });
        EVENT.bindEvent($("body"),".index_container","swipe",function(){
           // hideNavigator();
           return {
              sCallback : function(){},
              mCallback : function(){
        ...
        EVENT.bindEvent($("body"),".product_container","swipe",function(){
            return {
              sCallback : function(){},
              mCallback : function(){
                hideNavigator();
        ...
        EVENT.bindEvent($("body"),".about_container","swipe",function(){
            return {
              sCallback : function(){},
              mCallback : function(){
                hideNavigator();
        ...
        EVENT.bindEvent($(".mapContainer"),".back","click",function(){
            history.back();
        });
        function hideNavigator(){
            $(".collspased_container .collspased_items").removeClass("show_navigator").addClass("hide_navigator");
            $(".collspase").show();
            $(".collspased").hide();
            $(".collspased_items").on("webkitAnimationEnd",function(){
                $(".collspased_container").hide();
            })
        }
  }
...
var loading = (function($){
  var imgArr = $("[data-loading=true]"),
      me = {},
      loadStr = "<div class='spinner'>"+
                      "<div class='bounce1'></div>"+
                      "<div class='bounce2'></div>"+
                      "<div class='bounce3'></div>"+
                 "</div>";
  (function init(){
    imgArr.each(function(index,element){
      var current = this,
          isproad = $(current).attr("data-preloading"),
          url = $(current).attr("data-imgUrl");
      $(current).append(loadStr);
      if(isproad ==="true"){
        var img = new Image(),
                    type = $(current).attr("data-type");
        img.src = $(current).attr("data-imgUrl");
        img.onload = function(){
                    if(type == "bg"){
                        $(current).find(".spinner").remove();
                        $(current).css("background-image","url("+url+")");
                    }else{
                        $(current).find(".spinner").remove();
                        $(current).find("img").attr("src",url);
                    }
          img == null;
        }
      }
    ...
    me.destory = function(){
      var delayArray = $("[data-preloading=false]");
      delayArray.each(function(){
        var current = this,
            img = new Image(),
                type = $(current).attr("data-type"),
            url = $(current).attr("data-imgUrl");
